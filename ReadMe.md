...
Чёткое разделение слоёв: модели - транспорт - сервисы - репозитории.
...
# Запустить backend через makefile
make run
```
...
Будем рады вопросам, предложениям и замечаниям по пэт проекту...  
